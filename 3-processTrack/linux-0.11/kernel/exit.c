...
int do_exit(long code)
{
	...
	/* print message to show the running process exits in 3-processTrack */
		/* print running process exits to stdout */
	/* fprintk(1, "The ID of exiting process is %ld in %s\n", current->pid, "do_exit"); */
		/* print exiting process track to process.log */
